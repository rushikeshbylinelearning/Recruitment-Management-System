...
export default function Settings() {
  ...
  const [memberFormData, setMemberFormData] = useState({
    ...
    username: '',
    password: '',
    role: 'Recruiter' as 'Recruiter' | 'Admin' | 'HR Intern' | 'Team Lead' | 'Interviewer',
    ...
    try {
      ...
      if (response.success && response.data) {
        ...
        const members: TeamMember[] = response.data.users.map((user: any) => ({
          ...
          role: user.role as 'Recruiter' | 'Admin' | 'HR Intern' | 'Team Lead' | 'Interviewer',
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setMemberFormData(prev => ({ ...prev, role: e.target.value as 'Recruiter' | 'Admin' | 'HR Intern' | 'Team Lead' | 'Interviewer' }))}
