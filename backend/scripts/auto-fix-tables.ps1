# Auto-fix corrupted MySQL tables
# This script stops MySQL, deletes orphaned files, restarts MySQL, and recreates tables

Write-Host ""
Write-Host "Auto-fixing corrupted MySQL tables..." -ForegroundColor Cyan
Write-Host ""

# MySQL data directory
$dataDir = "C:\xampp\mysql\data\hr_workflow_db\"
$filesToDelete = @(
    "candidate_assignments.ibd",
    "candidate_notes.ibd",
    "in_app_notifications.ibd",
    "push_subscriptions.ibd"
)
...
node backend/scripts/recreate-tables-final.js
